...
export function landingPage(): string {
  ...
  return `${header()}<main id="main">
    ...
    <section class="download-band" aria-labelledby="download-title"><div><p class="eyebrow">Desktop app · version 0.1.0</p><h2 id="download-title">Keep the converter on your computer</h2><p>The app reads CSV and JSON exports. It also works when your internet is off.</p></div><div class="download-action"><a class="primary-button download-button" id="platform-download" href="https://github.com/B-Divyesh/sf-food-log-export-kit/releases">Downloads are being published</a><small id="download-note">Unsigned builds for macOS, Windows, and Linux.</small></div></section>
    <section class="product-preview" aria-labelledby="preview-title"><div class="section-intro"><p class="eyebrow">The product</p><h2 id="preview-title">See every row before you export</h2><p>Missing dates and unreadable numbers appear as notes. The archive explains which rows it could not use.</p></div>
    ...
    <section class="boundaries" aria-labelledby="boundaries-title"><div><p class="eyebrow light">Private by design</p><h2 id="boundaries-title">A converter, not another tracker</h2></div><ul><li><b>Your files stay local.</b><span>The app has no food-data server.</span></li><li><b>No account scraping.</b><span>Use exports you requested from your tracker.</span></li><li><b>No nutrition advice.</b><span>Numbers are copied and labeled, not judged.</span></li><li><b>No silent drops.</b><span>Skipped rows appear in conversion notes.</span></li></ul></section>
    <section class="pricing" aria-labelledby="price-title"><div class="price-copy"><p class="eyebrow">One job. One price.</p><h2 id="price-title">Combine several exports for $19</h2><p>A free archive handles one file at a time. The license adds multi-file selection for migrations split across years or apps.</p><ul><li>One-time purchase</li><li>License works on your devices</li><li>CSV and JSON export stay free</li></ul></div><div class="price-ticket"><span>PERSONAL LICENSE</span><strong><sup>$</sup>19</strong><small>one time</small><a class="primary-button" href="${checkoutUrl()}" rel="external">Buy the batch license</a><p>Sociobot/Dodo handles payment and refunds. <a href="/terms" data-link>Read the terms.</a></p></div></section>
  </main>${footer()}`;
}
...
export function notFoundPage(): string {
  ...
  return `${header()}<main id="main" class="not-found"><div><p class="eyebrow light">404 · Misfiled</p><h1 tabindex="-1">This card is not in the box</h1><p>The page may have moved. Your own files have not been touched.</p><a class="primary-button" href="/" data-link>Return to the archive</a></div><picture><source media="(max-width: 720px)" srcset="/art/archive-kitchen-720.webp"><img src="/art/archive-kitchen-1280.webp" width="1280" height="853" alt="An open recipe card box on a kitchen table." decoding="async"></picture></main>${footer()}`;
}
