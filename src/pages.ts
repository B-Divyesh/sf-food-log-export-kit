...
export function landingPage(): string {
  ...
  return `${header()}<main id="main">
    <section class="hero">
      ...
      <div class="hero-caption"><p>Keep a CSV for spreadsheets and JSON for a normalized local record.</p></div>
    </section>
    <section class="download-band" aria-labelledby="download-title"><div><p class="eyebrow">Desktop app · version 0.1.3</p><h2 id="download-title">Download the desktop app</h2><p>The app reads CSV and JSON exports. It also works when your internet is off.</p></div><div class="download-action"><a class="primary-button download-button" id="platform-download" href="https://github.com/B-Divyesh/sf-food-log-export-kit/releases">Downloads are being published</a><small id="download-note">Choose a build for your computer from the release page.</small></div></section>
    <section class="product-preview" aria-labelledby="preview-title"><div class="section-intro"><p class="eyebrow">Review before export</p><h2 id="preview-title">See every row before you export</h2><p>Invalid values, skipped rows, and populated unrecognized fields appear in conversion notes.</p></div>
    ...
    <section class="walkthrough" id="how" aria-labelledby="how-title"><div class="section-intro"><p class="eyebrow">How it works</p><h2 id="how-title">How to turn an export into an archive</h2></div><ol class="filmstrip">
      ...
      <li><figure><div class="frame"><img src="/screens/03-export.webp" width="760" height="489" alt="The filled review table with CSV and JSON export buttons." loading="lazy" decoding="async"></div><figcaption><span>03</span><h3>Save both formats</h3><p>Use CSV now. Keep JSON as the normalized archive.</p></figcaption></figure></li>
    </ol></section>
    <section class="boundaries" aria-labelledby="boundaries-title"><div><p class="eyebrow light">Privacy and limits</p><h2 id="boundaries-title">How the app handles your files</h2></div><ul><li><b>Your files stay local.</b><span>The app has no food-data server.</span></li><li><b>No account scraping.</b><span>Use exports you requested from your tracker.</span></li><li><b>No nutrition advice.</b><span>Numbers are copied and labeled, not judged.</span></li><li><b>Unmapped fields are reported.</b><span>The app names them and keeps their values in JSON.</span></li></ul></section>
    <section class="pricing" aria-labelledby="price-title"><div class="price-copy"><p class="eyebrow">Batch-import license</p><h2 id="price-title">Combine several exports for $19</h2><p>The free app handles one file at a time. The batch-import license adds multi-file selection for migrations split across years or apps.</p><ul><li>One-time purchase</li><li>Paste the license token on another device</li><li>CSV and JSON export stay free</li></ul></div><div class="price-ticket"><span>BATCH-IMPORT LICENSE</span><strong><sup>$</sup>19</strong><small>one time</small><a class="primary-button" href="${checkoutUrl()}" rel="external">Buy the batch-import license</a><p>Sociobot opens a checkout page hosted by Dodo. <a href="/terms" data-link>Read the terms.</a></p></div></section>
  </main>${footer()}`;
}
