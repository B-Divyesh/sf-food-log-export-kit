...
describe('Installer regression', () => {
  it('@claim:verified-installer parses spaced GitHub JSON, selects Linux and both Mac architectures, verifies, and installs a PATH launcher', () => {
    ...
    const linuxName = 'Food.Log.Export.Kit_0.1.14_amd64.AppImage';
    ...
    writeFileSync(identityPath, JSON.stringify({ version: '0.1.14', release_tag: 'v0.1.14', source_commit: fixtureSourceCommit }, null, 2));
