...
Audited 2026-08-28. Counts treat hyphenated terms and numbers as one word. No sentence exceeds 22 words. No sentence contains a banned marketing word.
...
| A converter, not another tracker. | 5 |
...
| Normalized saved collection | archive |
| Spreadsheet output | CSV |
| Complete portable output | JSON |
| Problem found during conversion | note |
| Paid multi-file capability | batch import |
| Try-out environment | demo |

Catalog description: “Turn food tracker exports into a local archive.” (8 words, 51 characters)
